    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
          ...
          <div class=" flex space-x-2 " >
            ...
            <form onsubmit="return confirm('Are You Sure ')" class="  flex px-4 py-2 bg-red-500 hover:bg-red-700 rounded-lg text-white" action="{{route('admin.reservation.destroy' ,$reservation->id)}}" method="POST">
                @method('DELETE')
                @csrf
