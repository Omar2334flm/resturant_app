                ...
                <div class="flex flex-col md:flex-row">
                    ...
                    <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                        <div class="w-full">
                            ...
                            <form method="POST" action="<?php echo e(route('reservation.store.step.two')); ?>">
                                <?php echo csrf_field(); ?>
                                    ...
                                    <div class="mt-1">
                                        <select id="table_id" name="table_id"
                                            ...
                                            <?php $__currentLoopData = $tables; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $table): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <option value="<?php echo e($table->id); ?>" <?php if($table->id == $reservations->table_id): echo 'selected'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="mt-6 p-4 flex justify-between">
                                    <a href="<?php echo e(route('reservation.step.one')); ?>"
...
<?php endif; ?><?php /**PATH C:\resturant-app\resources\views/reservations/step-two.blade.php ENDPATH**/ ?>