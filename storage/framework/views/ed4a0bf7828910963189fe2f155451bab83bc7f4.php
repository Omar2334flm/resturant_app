                ...
                <div class="space-y-8 divide-y divide-gray-200 w-1/2 mt-10">
                    <form  enctype="multipart/form-data" method="POST" action="<?php echo e(route('admin.menus.update' ,$menu->id)); ?>">
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div class="mt-1">
                                <input   value="<?php echo e($menu->name); ?>" type="text" id="name" name="name"
                        ...
                        <div class="sm:col-span-6">
                            ...
                            <div >
                                ...
                                <img src="<?php echo e(Storage::url($menu->image)); ?>" class="w-32 h-32 rounded">
...
<?php endif; ?>
<?php /**PATH C:\resturant-app\resources\views/admin/menus/edit.blade.php ENDPATH**/ ?>