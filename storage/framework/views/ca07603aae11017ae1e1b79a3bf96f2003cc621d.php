                ...
                <div class="flex flex-col md:flex-row">
                    ...
                    <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                        <div class="w-full">
                            ...
                            <form method="POST" action="<?php echo e(route('reservation.store.step.one')); ?>">
                                <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH C:\resturant-app\resources\views/reservations/step-one.blade.php ENDPATH**/ ?>